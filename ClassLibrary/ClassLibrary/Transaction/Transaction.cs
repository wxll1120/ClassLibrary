...
namespace ClassLibrary.Transaction
{
    ...
    {
        [ThreadStatic]
        private static bool transactionStart;

        [ThreadStatic]
        private static Dictionary<string, Transaction> currentTransactions;
        ...
        public static Dictionary<string, Transaction> CurrentTransactions
        {
            get { return currentTransactions; }
            set { currentTransactions = value; }
        }

        public static bool TransactionStart
        {
            get { return transactionStart; }
            set { transactionStart = value; }
        }
    }
