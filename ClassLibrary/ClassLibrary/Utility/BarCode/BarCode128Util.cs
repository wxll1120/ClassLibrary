...
namespace ClassLibrary.Common
{
    public class BarCode128Util
    {
            ...
            private string GetValue(Encode p_Code, string p_Value, ref int p_SetID)
            {
                ...
                string co = p_Code.ToString();
                DataRow[] _Row = m_Code128.Select(co + "='" + p_Value + "'");
            ...
            private void GetViewText(Bitmap p_Bitmap, string p_ViewText)
            {
                ...
                _Graphics.DrawString(p_ViewText, m_ValueFont, Brushes.Black, p_Bitmap.Width / 4, _StarY);
            }
            //12345678
